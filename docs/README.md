...
| [design/ibus-qingjian.md](design/ibus-qingjian.md) | 本 fork 的 Linux 壳设计：GNOME+Wayland+ibus 的 MVP 范围、ibus 架构与 D-Bus 接口面调研、librush/zbus 直连路线、与 Core 的对接、目录路径与开发调试流程 |
...
| [notes/dictionary-import.md](notes/dictionary-import.md) | 用户词库导入 / 更新 / 删除（2026-09-19）：脚本与文件级操作方式、各平台目录、Rime 与迁移的坑 |
